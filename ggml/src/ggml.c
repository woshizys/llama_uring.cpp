...
static ggml_moe_expert_get_device_data_callback g_moe_expert_get_device_data_cb = NULL;
...
void ggml_moe_expert_set_callback(
    ...
    g_moe_expert_get_device_data_cb = get_device_data;
...
const void * ggml_moe_expert_get_device_data(void * handle, int32_t expert, const void * fallback) {
    if (handle == NULL || g_moe_expert_get_device_data_cb == NULL) {
        return fallback;
    }
    return g_moe_expert_get_device_data_cb(g_moe_expert_cb_data, handle, expert, fallback);
}
