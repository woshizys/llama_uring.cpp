...
void ggml_cuda_mul_mat_q(
    ...
    if (!ids) {
        ...
        const mmq_args args = {
            src0_d, nullptr, src0->type, (const int *) src1_q8_1.ptr, nullptr, nullptr, dst_d,
    ...
    const mmq_args args = {
        src0_d, (const char * const *) x_ptrs, src0->type, (const int *) src1_q8_1.get(), ids_dst.get(), expert_bounds.get(), dst_d,
...
void ggml_cuda_op_mul_mat_q(
    ...
    const bool use_stream_k = ((GGML_CUDA_CC_IS_NVIDIA(cc) && ggml_cuda_highest_compiled_arch(cc) >= GGML_CUDA_CC_VOLTA)
                            ...
                            && src1_ncols == ne11;
    const mmq_args args = {
        src0_dd_i, nullptr, src0->type, (const int *) src1_ddq_i, nullptr, nullptr, dst_dd_i,
